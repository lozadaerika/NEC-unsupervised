    ...
    for learning_rate in learning_rates:
        for topology in topologies:
            for size in sizes:
                ...
                plt.ylabel('SOM Rows')
                plt.savefig('images/som/som-ds1-'+neighborhood_function+'-'+topology+'-'+str(learning_rate)+'-'+str(size)+'-heatmap.png')
                #plt.show()
                ...
                plt.xlabel('SOM Columns')
                plt.ylabel('SOM Rows')
                plt.savefig('images/som/som-ds1-'+neighborhood_function+'-'+topology+'-'+str(learning_rate)+'-'+str(size)+'-u-matrix.png')
                #plt.show()
...
plt.tight_layout()
plt.savefig('images/som/som-ds1-best-dendogram'+best_neighborhood_function+'-'+best_topology+'-'+str(best_learning_rate)+'-'+str(best_size)+'.png')
#plt.show()
